# Fina — Swift / SwiftUI Architecture

**App:** Fina · **Platform:** macOS 13 (Ventura)+ · **Language:** Swift 5.9 · **UI:** SwiftUI · **Pattern:** MVVM
...
```
Fina/
├── FinaApp.swift                        # @main entry point + auth gate
│
├── App/
...
#    Set bundle ID, e.g. com.yourname.fina
